    ...
    const customers = [
      {
        ...
        tags: JSON.stringify(['high-value', 'loyal']),
      ...
      },
      {
        ...
        phone: '+1234567892',
        siteId: zenbreezeSite.id,
        tags: JSON.stringify(['vip', 'repeat-buyer']),
    ...
    const products = [
      {
        ...
        stock: 50,
        category: 'tea-sets',
        images: JSON.stringify(['https://example.com/tea-set-1.jpg', 'https://example.com/tea-set-2.jpg'])
      },
      {
        originalId: 'prod_002',
        siteId: sogoodteaSite.id,
        ...
        stock: 100,
        category: 'green-tea',
        images: JSON.stringify(['https://example.com/green-tea.jpg'])
      },
      {
        originalId: 'prod_003',
        siteId: zenbreezeSite.id,
        ...
        images: JSON.stringify(['https://example.com/accessories.jpg'])
      }
    ];
